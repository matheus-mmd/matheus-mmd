...
<img width="97%" src="https://github-profile-summary-cards.vercel.app/api/cards/profile-details?username=matheus-mmd&theme=github_dark" alt="Resumo do perfil de matheus-mmd: contribuições, repositórios públicos e curva de contribuições do último ano" />

<br />

<img width="48%" src="https://github-profile-summary-cards.vercel.app/api/cards/repos-per-language?username=matheus-mmd&theme=github_dark" alt="Repositórios por linguagem" />
<img width="48%" src="https://github-profile-summary-cards.vercel.app/api/cards/most-commit-language?username=matheus-mmd&theme=github_dark" alt="Linguagens com mais commits" />
...
<sub>
O card de perfil e a animação Snake cobrem os <b>últimos 365 dias</b>; o card de totais é <b>acumulado</b> da conta.
Todos os números são lidos ao vivo da API do GitHub por
...
<!--
  OPCIONAL — cards do github-readme-stats (anuraghazra) e do streak-stats.
  NECESSITA VERIFICAÇÃO: no momento em que este README foi montado, a instância
  pública github-readme-stats.vercel.app respondia 503 (limite de requisições
  compartilhado) e streak-stats.demolab.com não respondia. Se quiser usá-los,
  o caminho estável é publicar sua própria instância no Vercel e trocar o domínio.

<img width="48%" src="https://github-readme-stats.vercel.app/api?username=matheus-mmd&show_icons=true&hide_border=true&count_private=true&include_all_commits=true&bg_color=0D1117&title_color=38BDF8&text_color=C9D1D9&icon_color=6366F1&locale=pt-br" alt="Estatísticas do GitHub" />
<img width="48%" src="https://streak-stats.demolab.com?user=matheus-mmd&locale=pt_BR&hide_border=true&background=0D1117&stroke=1F2937&ring=38BDF8&fire=6366F1&currStreakLabel=38BDF8" alt="Sequência de contribuições" />
-->
...
<sub>Gerada automaticamente todos os dias pelo workflow <a href="./.github/workflows/snake.yml"><code>.github/workflows/snake.yml</code></a> a partir do gráfico real de contribuições. O passo a passo da configuração está no final desta página.</sub>
...
<details>
<summary><b>▸ Como a cobrinha é gerada</b></summary>

<br />

O workflow [`.github/workflows/snake.yml`](./.github/workflows/snake.yml) usa a action
[`Platane/snk`](https://github.com/Platane/snk) para ler o gráfico público de contribuições
de `matheus-mmd` e desenhar a animação. Ele roda **todo dia às 03:00 UTC**, a cada push na
branch padrão e também sob demanda.

**Passo a passo**

1. O arquivo já está versionado neste repositório em `.github/workflows/snake.yml`.
2. Em **Settings → Actions → General → Workflow permissions**, marque **Read and write permissions**.
3. Vá em **Actions → Generate Snake Animation → Run workflow** para gerar a primeira vez.
4. O job publica `snake-dark.svg` e `snake-light.svg` na branch órfã **`output`**.
5. O README consome os arquivos direto do `raw.githubusercontent.com`, no bloco `<picture>` acima,
   trocando automaticamente entre tema claro e escuro do GitHub.

Enquanto o workflow não rodar pela primeira vez, a imagem aparece quebrada — isso é esperado.
